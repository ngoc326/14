    ...
    public partial class FrmDiem : Form
    {
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < tblDiem.Rows.Count; i++)
            {
                ...
                {
                    sql = "UPDATE Diem SET Diem = ROUND(" + GridViewDiem.Rows[i].Cells["clmDiem"].Value.ToString() + ",1) WHERE MaSV=N'" + GridViewDiem.Rows[i].Cells["clmMaSV"].Value.ToString() + "'AND MaLop=N'" + cmbMaLop.SelectedValue + "' and HocKy = '" + cmbHocKy.Text + "'AND MaMon='" + cmbMonHoc.SelectedValue + "' and LanThi='" + txtLanThi.Text.Trim() + "'";
                    DAO.RunSql(sql);
                    if (Convert.ToDouble(GridViewDiem.Rows[i].Cells["clmDiem"].Value.ToString().Trim()) < 5)
                    {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "UPDATE Diem SET Diem = ROUND(" + GridViewDiem.CurrentRow.Cells["clmDiem"].Value.ToString() + ",1) WHERE MaSV=N'" + GridViewDiem.CurrentRow.Cells["clmMaSV"].Value.ToString() + "'AND MaLop=N'" + cmbMaLop.SelectedValue + "' and HocKy = '" + cmbHocKy.Text + "'AND MaMon='" + cmbMonHoc.SelectedValue + "' and LanThi='" + txtLanThi.Text.Trim() + "'";
                DAO.RunSql(sql);
